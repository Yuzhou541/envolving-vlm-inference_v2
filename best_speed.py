"""Accuracy-focused manual optimization for Qwen3-VL-2B-Instruct on CharXiv."""
import os
import re
...
_BASE_RULES = (
    "Answer the chart question with the final answer only.\n"
    "Output exactly one short line.\n"
    "Do not explain your reasoning.\n"
    "Do not add prefixes like Answer:, The answer is, or quotes.\n"
